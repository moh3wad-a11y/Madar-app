...
class _SupplierPickerSheetState extends ConsumerState<SupplierPickerSheet> {
  ...
  Widget build(BuildContext context) {
    final l10n = AppLocalizations.of(context)!;
    final resultsAsync = ref.watch(supplierSearchProvider(_query));
          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  Text(l10n.supplierOptional, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
                  TextButton.icon(
                    onPressed: () => setState(() {
                      _showAddForm = !_showAddForm;
                      _addError = null;
                    }),
                    icon: Icon(_showAddForm ? Icons.close : Icons.add_business_outlined, size: 18),
                    label: Text(_showAddForm ? l10n.cancel : l10n.addSupplier),
                  ),
                ],
              ),
              if (_showAddForm) ...[
